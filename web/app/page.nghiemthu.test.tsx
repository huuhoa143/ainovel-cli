...
test('`Trang` nối `taiLai` THẬT của studio vào dải — bấm Cho đi tiếp thì snapshot được nạp lại', async () => {
...
test('sợi dây `taiLai` cũng liền ở bề mặt KIỂM ĐỊNH, không riêng buồng lái', async () => {
